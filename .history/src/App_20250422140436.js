...
export default function AgencyLandingPage() {
  return (
    <div className="min-h-screen bg-[#fdfcfa] text-gray-900 font-sans">
      ...
      {/* Pain Point Section */}
      <section className="px-6 py-20 bg-[#f8f8f5] text-center">
        <h2 className="text-4xl font-bold mb-4">That Technical Co-founder You’ve Been Looking For</h2>
        ...
        <div className="mt-10 text-lg text-gray-700">
          <p><strong>Software Agency?</strong> Maybe.</p>
          <p><strong>Software Agent?</strong> Absolutely.</p>
