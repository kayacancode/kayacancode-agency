...
export default function AgencyLandingPage() {
  const testimonials = [
    {
      author: 'Kontji Anthony, Founder @ Youdle',
    ...
    {
      author: 'Placeholder Name, Startup X',
      text: 'This is a placeholder testimonial for future video or text-based feedback. It will rotate in a slider style.',
    },
    {
      author: 'Placeholder Name, Startup Y',
      text: 'Another client placeholder testimonial. Consider embedding a short video clip here in the future.',
    },
  ];
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-left">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-4">
              Kaya Jones is a product-minded software engineer and AI developer who built Kayacancode to help startups launch faster with smarter tech. With a background in AI, product development, and startup innovation, Kaya has worked on everything from government-backed research to founder-led MVP builds.
            </p>
            <p className="text-lg text-gray-700">
              Passionate about clarity, transparency, and speed, Kaya leads with the belief that tech should serve people. From hands-on coding to leading product strategy calls, he’s the technical co-founder early-stage teams can trust.
            </p>
          </div>
        </div>
      </motion.section>
