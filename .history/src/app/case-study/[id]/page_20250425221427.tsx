...
export default function CaseStudyPage() {
  ...
  const caseStudy = {
    ...
    problem: 'AI can be overwhelming, too many tools, no clear transparency, no communication',
    mission: 'We can make the world a far better place by helping more companies leverage the technology that\'s available today, especially AI– but it\'s confusing & hard to figure out how to implement it, and it\'s our job to help businesses navigate this confusing tech landscape.',
    targetAudience: 'Early stage Companies trying to get a product to market fast with AI Integrations. People trying to make a proof of concept fast.',
    image: '/thryve.png',
        ...
        >
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-700 mb-4">{caseStudy.problem}</p>
              <p className="text-lg text-gray-700">Non-technical people want to build however they don't have the time and network. They try to go for cheap labor overseas however there is no transparency and easy communication. People want that tech person apart of their team.</p>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Our Mission</h2>
              <p className="text-lg text-gray-700">{caseStudy.mission}</p>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Who We Serve</h2>
              <p className="text-lg text-gray-700">{caseStudy.targetAudience}</p>
            </div>
