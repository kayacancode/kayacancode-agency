...
export default function Home() {
  ...
  const mission = 'We can make the world a far better place by helping more companies leverage the technology that is available today, especially AI– but it is confusing & hard to figure out how to implement it, and it&apos;s our job to help businesses navigate this confusing tech landscape.';
