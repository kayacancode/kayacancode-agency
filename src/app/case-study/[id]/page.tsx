...
export default function CaseStudyPage() {
  ...
  const caseStudy = {
    ...
    investment: {
      ...
      note: 'Projects of this scale and complexity typically start at $10,000, with the final cost ranging depending on feature depth, integrations, and AI requirements.'
    },
    features: [
      {
